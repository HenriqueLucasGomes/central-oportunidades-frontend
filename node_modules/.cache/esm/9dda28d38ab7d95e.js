let imagemData;_8ab‍.x([["fora",()=>fora]]);_8ab‍.w("../models/foto.js",[["imagemData",["imagemData"],function(v){imagemData=v}]]);//importação dos dados da imagem
// import {dados} from '../controllers/dados.js'
    ...
    var dado={
        //info empresa
        contratante:document.querySelector("#unidade2").value,//'International Business Machines Corporation',
        cnpj:document.querySelector("#cnpj2").value,//' 12.345.678/9012-34',
        rua_empresa:document.querySelector("#rua2").value,//'Afonso pena',
        num_endereco_empresa:document.querySelector("#numero2").value,//'12',
        cep_empresa:document.querySelector("#cep2").value,//'12345-678',
        bairro_empresa:document.querySelector("#bairro2").value,//'Serrrinha',
        municipio_empresa:document.querySelector("#municipio2").value,//'Ibirité',
        estado_empresa:document.querySelector("#estado2").value,//'Minas Gerais',
        //info representante empresa
        // representante:document.querySelector("#").value,// 'Zeca pagodinho',
        // num_identidade_representante:document.querySelector("#").value,//"MG-12.345.678",
        // cpf_representante:document.querySelector("#").value,// "123456789-00",
        // rua_representante:document.querySelector("#").value,//'Afonso pena',
        // num_endereco_representante:document.querySelector("#").value,//'12',
        // cep_representante:document.querySelector("#").value,//'12345-678',
        // bairro_representante:document.querySelector("#").value,//'Serrrinha',
        // municipio_representante:document.querySelector("#").value,//'Ibirité',
        // estado_representante:document.querySelector("#").value,//'Minas Gerais',
        //info estudante
        // estudante:document.querySelector("#").value,// "Pedroso pedro da silva mendes",
        // num_identidade_estudante:document.querySelector("#").value,//"MG-12.345.678",
        // cpf_estudante:document.querySelector("#").value,// "123456678-90",
        // rua_estudante:document.querySelector("#").value,//'Afonso pena',
        // num_endereco_estudante:document.querySelector("#").value,//'12',
        // cep_estudante:document.querySelector("#").value,//'12345-678',
        // bairro_estudante:document.querySelector("#").value,//'Serrrinha',
        // municipio_estudante:document.querySelector("#").value,//'Ibirité',
        // estado_estudante:document.querySelector("#").value,//'Minas Gerais',
        // tel_estudante:document.querySelector("#").value,// "999999999",
        // ano:document.querySelector("#").value,//"1",
        // curso:document.querySelector("#").value,//"Informatica",
        // matricula:document.querySelector("#").value,//"2017951111",
        //Area do ADM
        ...
        //info estagio
        // salario:document.querySelector("#").value,//"200",
        // salario_ext:document.querySelector("#").value,//"duzentos",
        // valor_aux:document.querySelector("#").value,//"30",
        // valor_aux_ext:document.querySelector("#").value,//"trinta",
        // duracao:document.querySelector("#").value,//"400",
        // duracao_ext:document.querySelector("#").value,//"quatrocentas",
        // data_ini:document.querySelector("#").value,//"01/03/2019",
        // data_ter:document.querySelector("#").value,//"15/10/2019",
        // horas_sem:document.querySelector("#").value,//"12",
        // horas_sem_ext:document.querySelector("#").value,//'doze',
        // horas_dia:document.querySelector("#").value,//"4",
        // horas_dia_ext:document.querySelector("#").value,//'quatro',
        // supervisor:document.querySelector("#").value,//"Airton Sena",
        // coordenador:document.querySelector("#").value,//"Ivete Sangalo"
    }
    var doc = new jsPDF()
    _8ab‍.g.console.log(dados)
    
    //Se é remunerado ou não
    if(dado.salario==0){
...
Federal de Minas Gerais, para a realização de estágio curricular obrigatório.`,40, 75)
    ...
    Fica compromissado que o estágio curricular terá duração de `+dado.duracao+` (`+dados.duracao_ext+`) horas, tendo início em `+dado.data_ini+` e
