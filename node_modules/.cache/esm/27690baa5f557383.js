let imagemData;_5f5‍.x([["protocolo",()=>protocolo]]);_5f5‍.w("../models/foto.js",[["imagemData",["imagemData"],function(v){imagemData=v}]]);//importação dos dados da imagem
// import {dados} from './dados.js'

// const imagemData=require("../models/foto.js")

       const protocolo= function (n){
    
    //console.log("FOI")
    var dado={
        num1:'55555',//ADM
        num2:'333',//ADM
        diretor:'Prof. Kátia Pedroso Silveira',//ADM
        num_competencia:'6.607',//ADM
        data:'02/10/2018',//ADM
        //info contratante
        contratante: document.querySelector("#unidade"+n).value,//'International Business Machines Corporation',
        cnpj:document.querySelector("#cnpj"+n).value,//' 12.345.678/9012-34',
        rua:document.querySelector("#rua"+n).value,//'Afonso pena',
        num_endereco:document.querySelector("#numero"+n).value,//'12',
        cep:document.querySelector("#cep"+n).value,//'12345-678',
        bairro:document.querySelector("#bairro"+n).value,//'Serrrinha',
        municipio:document.querySelector("#municipio"+n).value,//'Ibirité',
        estado:document.querySelector("#estado"+n).value//'Minas Gerais'
    }   
