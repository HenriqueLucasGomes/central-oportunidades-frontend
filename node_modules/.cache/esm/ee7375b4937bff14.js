let imagemData;_937‍.x([["dentro",()=>dentro]]);_937‍.w("../models/foto.js",[["imagemData",["imagemData"],function(v){imagemData=v}]]);//importação dos dados da imagem
// import {dados} from '../controllers/dados.js'
    ...
    var dado={ 
        //info unidade
        unidade_ufmg:document.querySelector("#unidade1").value,//"Instituto de Ciências Exatas",
        cnpj_unidade:document.querySelector("#cnpj1").value,//"17.217.985/0001-04",
        rua_unidade:document.querySelector("#rua1").value,//"Avenida Presidente Antonio Carlos",
        num_endereco_unidade:document.querySelector("#numero1").value,//"6.627",
        cep_unidade:document.querySelector("#cep1").value,//"31270-901",
        bairro_unidade:document.querySelector("#bairro1").value,//"Pampulha",
        municipio_unidade:document.querySelector("#municipio1").value,//"Belo Horizonte",
        estado_unidade:document.querySelector("#estado1").value,//"Minas Gerais",
        supervisor:document.querySelector("#supervisor1").value,//"Cesar albuquerque Medeiros",//diretor
        //Area do ADM
        num_poderes:"3.147",
        ...
        //info aluno
        esudante:document.querySelector("#nome1").value,//"Alberto Carlos Alberga dos Santos",
        num_identidade_estudante:document.querySelector("#identidade1").value,//"MG-12.345.678",
        cpf_estudante: document.querySelector("#cpf1").value,//"123456678-90",
        rua_estudante:document.querySelector("#rua_e1").value,//'Afonso pena',
        num_endereco_estudante:document.querySelector("#numero_e1").value,//'12',
        cep_estudante:document.querySelector("#cep_e1").value,//'12345-678',
        bairro_estudante:document.querySelector("#bairro_e1").value,//'Serrrinha',
        municipio_estudante:document.querySelector("#municipio_e1").value,//'Ibirité',
        estado_estudante:document.querySelector("#estado_e1").value,//'Minas Gerais',
        tel_estudante: document.querySelector("#tel_e1").value,//"999999999",
        ano:document.querySelector("#ano_e1").value,//"1",
        curso:document.querySelector("#curso_e1").value,//"Informatica",
        matricula:document.querySelector("#matricula_e1").value,//"2017951111",
        //info estagio
        salario: document.querySelector("#remumera1").value,//"200",
        ...
        supervisor: document.querySelector("#").value,//"Airton Senna",
